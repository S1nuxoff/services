...
Тут зібрані мої актуальні проєкти: Telegram-боти та приватний кінотеатр Nestify (opencine.cloud).  
Кожен інструмент робився “під себе” або під конкретний бізнес-запит, з акцентом на зручність, автоматизацію й живу аналітику.
